                        ...
                        for (;;) {
                            ...
                            if (typeof t == "undefined" || !t.length || !t[0]) {
                                if (!k) {
                                    ...
                                    var B = "";
                                    this.lexer.showPosition ? B = "Parse error occur at line " + (i + 1)+ ":<br/>" + this.lexer.showPosition() + "<br/>Missing " + A.join(", ") + " characters, in fact it is '" + this.terminals_[q] + "'" : B = " at line "+ (i + 1)+" occur parse error " + ": need " + (q == 1 ? "at the end input" : "'" + (this.terminals_[q] || q) + "'"), this.parseError(B, {
                    ...
                    b = function() {
                        var a = {
                            ...
                            showPosition: function() {
                                ...
                                return "<code>"+ a + this.upcomingInput() + "</code><br/><code style='visibility: hidden'>" + a + '</code><i class="fa fa-arrow-up" style="color:green;"></i>'
                            },
                            next: function() {
                                ...
                                this.parseError("Parse error occur at line " + (this.yylineno + 1) + ". Unrecognizable characters.<br/>" + this.showPosition(), {
                                    text: "",
                                    token: null,
                                    line: this.yylineno
                                })
